...
const PROMPT_DIR = path.join(ROOT, "NEUROVA_PROMPT");
...
if (!exists(PROMPT_DIR)) die("Missing NEUROVA_PROMPT/");
if (!exists(PACKS_DIR)) die("Missing NEUROVA_PROMPT/packs/");
if (!exists(PL_FILE)) die("Missing NEUROVA_PROMPT/prompt-library.html");
