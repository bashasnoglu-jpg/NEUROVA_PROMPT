...
This document outlines the design system and coding standards for the SANTIS website.
...
We use a simplified BEM-like syntax prefixed with `nv-` (SANTIS) to avoid conflicts.
