# SANTIS – Grafik Master Kit (Kanonik)

Bu belge, SANTIS markasının görsel ve dijital tasarım sisteminin temelini oluşturur.
...
> SANTIS’da variant farkı “bağırmaz”, *fısıldar*.
