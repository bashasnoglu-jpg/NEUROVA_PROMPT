# NEUROVA Internal Staff Guide (EN) v1.0

## 1. What is Prompt Library?
- A single technical surface that hosts every pack, language block, and safeNote you use on site—this is the NEUROVA İstek Kütüphanesi (Prompt Library).
...
- Staff Quick Guide (EN): `docs/NEUROVA_Staff_Quick_Guide_EN_A4.md`
