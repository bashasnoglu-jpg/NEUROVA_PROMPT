...
- Keep references to signature catalog regions (Recovery, Ayurvedic, Hamam, Seasonal Detox) in the story copy.

## Safe Note Rules
- **Hamam / Kids & Family / Signature / Face – Sothys** require clear safeNotes (see `assets/safe-notes/`).
- Avoid medical claims, before-after promises, or hard clinical language.
- Offer guest choice language: “choose pressure”, “pause anytime”, “guardian nearby”, “hydration reminder”.
- Mirror secure expressions when referencing treatments (close-up kese, steam, kids playfulness).
