  ...
  window.NV_PROMPT_PACKS[KEY] = [
    {
      ...
      role: "Therapist",
      title: "Teen Karşılama (Saygılı Ton)",
      lang: {
    ...
    },
    {
      ...
      lang: {
        tr: "Bacaklar ve bel için kontrollü bir rahatlatma uygulayacağım. Basıncı istediğin an ayarlayabilir ya da durdurabilirsin.",
